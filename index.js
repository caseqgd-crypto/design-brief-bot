        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Ты — senior дизайнер. Проанализируй дизайн на фото. Ответ пиши строго по шаблону ниже, только на русском, без звездочек и символов разметки.\n\nШаблон ответа:\nОбщая оценка: число/100\n\nОшибки:\nтекст ошибок\n\nПлюсы:\nтекст плюсов\n\nРекомендации:\nтекст рекомендаций",
              },
              {
                type: "image_url",
                image_url: {
