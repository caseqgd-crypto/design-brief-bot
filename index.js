        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Ты — senior дизайнер. Проанализируй дизайн на фото. Оцени от 1 до 100. Найди плюсы, минусы и дай рекомендации. Пиши только на русском. НЕ используй звездочки и символы разметки. Формат: просто текст с эмодзи.",
              },
              {
                type: "image_url",
                image_url: {
